    ...
    return (
        <div className="cgu">
            ...
            <div className="c_cgu">
                ...
                <br/><br/>
                <div className="date">En vigueur au 01/01/1900</div>
                <br/><br/>

                <p>
                Les présentes conditions générales d'utilisation (dites « <b>CGU</b> ») ont pour objet l'encadrement juridique
                des modalités de mise à disposition du site et des services par _______________ et de définir les 
                conditions d’accès et d’utilisation des services par « <b>l'Utilisateur</b> ».
                Les présentes CGU sont accessibles sur le site à la rubrique «<b>CGU</b>».
                </p>
                ...
                http://www.chicknfish.be se réserve le droit de modifier unilatéralement et à tout moment le contenu 
                des présentes CGU.
                </p>


                <div className="article">ARTICLE 1 : Les mentions légales</div>
                <p>
                L’édition et la direction de la publication du site http://www.chicknfish.be est assurée par Sacré 
                Clémentine, domicilié Traverse d'Esope 4, 1348 Ottignies-Louvain-la-Neuve.
                Numéro de téléphone est 010451072
                Adresse e-mail chicknfish00@gmail.com.
                L'hébergeur du site http://www.chicknfish.be est la société Heroku, dont le siège social est situé au 
                ASBL, avec le numéro de téléphone : 0000000000.
                </p>
                

                <div className="article">ARTICLE 2 : Accès au site</div>
                <p>
                Le site http://www.chicknfish.be permet à l'Utilisateur un accès gratuit aux services suivants :
                Le site internet propose les services suivants :
                Restaurant permettant de commander des plats à emporter / à livrer
                ...
                1Pour accéder aux services, l’Utilisateur doit ensuite s'identifier à l'aide de son identifiant et de son mot 
                ...
                la responsabilité de http://www.chicknfish.be. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir 
                ...
                <div className="article">ARTICLE 3 : Collecte des données</div>
                <p>
                ...
                et aux libertés. Le site est déclaré à la CNIL sous le numéro XXXXXXXXXX.
                ...
                <div className="article">ARTICLE 4 : Propriété intellectuelle</div>
                <p>
                ...
                <div className="article">ARTICLE 5 : Responsabilité</div>
                <p>
                Les sources des informations diffusées sur le site http://www.chicknfish.be sont réputées fiables mais 
                ...
                Malgré des mises à jour régulières, le site http://www.chicknfish.be ne peut être tenu responsable de 
                la modification des dispositions administratives et juridiques survenant après la publication. De même,
                2le site ne peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue 
                dans ce site.
                ...
                Le site http://www.chicknfish.be ne peut être tenu pour responsable d’éventuels virus qui pourraient 
                ...
                <div className="article">ARTICLE 6 : Liens hypertextes</div>
                <p>
                Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces 
                liens, il sortira du site http://www.chicknfish.be. Ce dernier n’a pas de contrôle sur les pages web sur 
                lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.
                </p>
                

                <div className="article">ARTICLE 7 : Cookies</div>
                <p>
                ...
                l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site http://www.chicknfish.be. 
                ...
                L’information contenue dans les cookies est utilisée pour améliorer le site http://www.chicknfish.be.
                ...
                <div className="article">ARTICLE 8 : Publication par l’Utilisateur</div>
                <p>
                ...
                3Le membre reste titulaire de l’intégralité de ses droits de propriété intellectuelle. Mais en publiant une 
                ...
                <div className="article">ARTICLE 9 : Droit applicable et juridiction compétente</div>
                <p>
                ...
                <div className="lien">CGU réalisées sur <a href="http://legalplace.fr">http://legalplace.fr</a></div>
            </div>
        </div>
    );
}
