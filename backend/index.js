...
app.delete('/api/menu/:idProduit', (req, res) => {
...
app.delete('/api/orders', (req, res) => {
  ...
  JOIN reservations ON reservations.IdCommande = commandes.IdCommande \
  WHERE reservations.IdCommande = ? \
